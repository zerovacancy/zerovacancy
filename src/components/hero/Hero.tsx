  ...
  bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAiIGhlaWdodD0iNDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGcgZmlsbD0ibm9uZSIgc3Ryb2tlPSIjOG
  E2NGZmIiBzdHJva2Utd2lkdGg9IjAuNSIgc3Ryb2tlLW9wYWNpdHk9IjAuMDYiPjxwYXRoIGQ9Ik0wIDBMNDAgNDAiLz48cGF0aCBkPSJNNDAgMEwwIDQwIi8+PC9nPjwvc3ZnPg==')] 
  opacity-50"></div>
        ...
        >
                ...
                <span className="flex flex-col items-center">
                  ...
                  <span 
                    className={cn(
                      ...
                      "font-bold font-jakarta tracking-[-0.01em]",
          ...
          >
            Property spaces deserve visionaries, not vendors. Connect with creators who see beyond square footage to capture the soul of your spaces. Our
  curated network transforms properties into visual narratives that intrigue, inspire, and ultimately convert.
          </div>
        </div>
        ...
        >
          ...
          <WaitlistCTA className="mb-4 sm:mb-6" buttonText="RESERVE YOUR SPOT" />
        </div>
