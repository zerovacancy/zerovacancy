    ...
    return (
      <div>
        <div className="flex items-center mb-1.5">
          <div className="w-0.5 h-3 bg-gradient-to-b from-indigo-500 
  to-purple-500 rounded-full mr-1.5"></div>
          <span className="text-xs text-gray-500 font-medium">RECENT
  WORK</span>
        </div>
          ...
          {ensuredExamples.map((example, index) => (
            <div 
              ...
              className={cn(
                ...
                isMobile ? "h-16 w-[calc(33.333%-4px)]" : "h-18 
  w-[calc(33.333%-4px)]",
                "bg-gray-50"
              )}
            >
  ...
  transition-transform duration-300"
                onError={(e) => {
                  ...
                  target.src = '/placeholder.svg'; // Fallback to
  placeholder
                }}
              />
            </div>
  ...
  hover:text-indigo-800 transition-colors duration-200 font-medium">
