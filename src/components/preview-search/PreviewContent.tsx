...
import React from 'react';
  ...
  export const PreviewContent: React.FC = () => {
    ...
    // Sample creators count - in production, this would come from search 
  results
  ...
  mx-auto">
            Browse our curated network of professional content creators,
  photographers, and videographers.
        ...
        <div className={cn(
          "bg-gray-50/60 border border-gray-100 rounded-lg overflow-hidden 
  shadow-sm",
          isMobile ? "p-4" : "p-6"
        )}>
